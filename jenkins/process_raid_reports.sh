...
cp /simc/reports/Raid_T17H_AOE.html /simc/reports/archive_html/${NOW}_Raid_T17H_AOE.html
gzip /simc/reports/archive_html/${NOW}_Raid_T17H_AOE.html

cp /simc/reports/Raid_T17H_AddWaves.html /simc/reports/archive_html/${NOW}_Raid_T17H_AddWaves.html
gzip /simc/reports/archive_html/${NOW}_Raid_T17H_AddWaves.html
...
cp /simc/reports/_Raid_T17H_AddWaves.txt /simc/reports/archive_txt/${NOW}_Raid_T17H_AddWaves.txt
