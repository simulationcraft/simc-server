...
${SIMC_CLI_PATH}/simc DS_Dungeon.simc fight_style=DungeonSlice iterations=${simc_iterations} html=${SIMC_OUTPUT_PATH}/T23_Raid_DungeonSlice.html threads=${available_cpus} ${other_options} > ${SIMC_OUTPUT_PATH}/T23_Raid_DungeonSlice.txt
