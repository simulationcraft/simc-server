...
${SIMC_CLI_PATH}/simc aoe_Raid_T17H.simc ${aoe_options} iterations=5000 html=${SIMC_OUTPUT_PATH}/Raid_T17H_AOE.html threads=${available_cpus} ${other_options} > ${SIMC_OUTPUT_PATH}/Raid_T17H_AOE.txt
${SIMC_CLI_PATH}/simc aoe_Raid_T17H.simc ${aoe_options2} iterations=5000 html=${SIMC_OUTPUT_PATH}/Raid_T17H_AddWaves.html threads=${available_cpus} ${other_options} > ${SIMC_OUTPUT_PATH}/Raid_T17H_AddWaves.txt